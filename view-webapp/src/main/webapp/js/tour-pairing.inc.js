...
onLoad(()=>{
  ...
  // Publish pairings to website (server-side render, no DOM scrape)
  $('#publish-pairings').on('click', e => {
    ...
    api.postJson(`webhook/publish/pairings/${code}/${activeRound}?id=${tour_id}`, {})
      .then(data => {
